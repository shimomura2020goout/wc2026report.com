...
> {
  ...
  const response = await client.messages.create({
    ...
    messages: [
      {
        role: "user",
        content: `あなたはサッカーW杯2026の情報サイト「W杯2026 × toto」のライターです。
...
[
  {
    ...
    "category": "ニュース",
    "tags": ["日本代表", "W杯"]のように適切なタグを選択。選択肢: 日本代表, W杯, toto, DAZN, グループH, オランダ, チュニジア, 注目選手, 戦術分析",
    "sourceUrl": "元記事のURL",
    "sourceName": "元記事の出典名"
  }
]
