...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t("kickoff.metaTitle"),
    description: t("kickoff.metaDescription"),
    alternates: pageAlternates(locale, "/kickoff"),
    openGraph: {
      title: t("kickoff.ogTitle"),
      description: t("kickoff.ogDescription"),
      url: absoluteLocaleUrl(locale, "/kickoff"),
      type: "website",
    },
  };
}
