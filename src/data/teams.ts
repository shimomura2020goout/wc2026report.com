...
// ========================================
// 全48チーム — Notion から自動生成（2026-05-05）
...
export const allTeams: Team[] = [
  ...
  { name: "モロッコ", code: "MAR", group: "C", fifaRanking: 8, fifaPoints: 1756.8, fifaPrevPoints: 1737, region: "CAF", regionLabel: "アフリカ", wcAppearances: 7, bestResult: "4位（2022）", flag: "🇲🇦" },
  ...
  // --- グループ G ---
  { name: "イラン", code: "IRN", group: "G", fifaRanking: 21, fifaPoints: 1615.3, fifaPrevPoints: 1617, region: "AFC", regionLabel: "アジア", wcAppearances: 7, bestResult: "GL敗退（1978-2022）", flag: "🇮🇷" },
  ...
  { name: "ウズベキスタン", code: "UZB", group: "K", fifaRanking: 50, fifaPoints: 1469.4, fifaPrevPoints: 1462, region: "AFC", regionLabel: "アジア", wcAppearances: 1, bestResult: "初出場", flag: "🇺🇿" },
  ...
  { name: "コンゴ民主共和国", code: "COD", group: "K", fifaRanking: 46, fifaPoints: 1480, fifaPrevPoints: 1475, region: "CAF", regionLabel: "アフリカ", wcAppearances: 2, bestResult: "GL敗退（1974 ※ザイール時代）", flag: "🇨🇩" },
