...
export const allTeams: Team[] = [
  ...
  { name: "韓国", code: "KOR", group: "A", fifaRanking: 25, region: "AFC", regionLabel: "アジア", wcAppearances: 11, bestResult: "4位（2002）", flag: "🇰🇷" },
  { name: "南アフリカ", code: "RSA", group: "A", fifaRanking: 59, region: "CAF", regionLabel: "アフリカ", wcAppearances: 4, bestResult: "GL敗退（1998-2010）", flag: "🇿🇦" },
  { name: "チェコ", code: "CZE", group: "A", fifaRanking: 41, region: "UEFA", regionLabel: "ヨーロッパ", wcAppearances: 2, bestResult: "準優勝（1962 ※チェコスロバキア時代）", flag: "🇨🇿" },
  ...
  { name: "カタール", code: "QAT", group: "B", fifaRanking: 55, region: "AFC", regionLabel: "アジア", wcAppearances: 2, bestResult: "GL敗退（2022）", flag: "🇶🇦" },
  { name: "スイス", code: "SUI", group: "B", fifaRanking: 19, region: "UEFA", regionLabel: "ヨーロッパ", wcAppearances: 13, bestResult: "ベスト8（1934-1954）", flag: "🇨🇭" },
  { name: "ボスニア・ヘルツェゴビナ", code: "BIH", group: "B", fifaRanking: 63, region: "UEFA", regionLabel: "ヨーロッパ", wcAppearances: 1, bestResult: "初出場", flag: "🇧🇦" },
  ...
  { name: "スコットランド", code: "SCO", group: "C", fifaRanking: 43, region: "UEFA", regionLabel: "ヨーロッパ", wcAppearances: 9, bestResult: "GL敗退（1954-1998）", flag: "🏴󠁧󠁢󠁳󠁣󠁴󠁿" },
  ...
  { name: "トルコ", code: "TUR", group: "D", fifaRanking: 22, region: "UEFA", regionLabel: "ヨーロッパ", wcAppearances: 3, bestResult: "3位（2002）", flag: "🇹🇷" },

  // --- グループ E ---
  { name: "ドイツ", code: "GER", group: "E", fifaRanking: 10, region: "UEFA", regionLabel: "ヨーロッパ", wcAppearances: 21, bestResult: "優勝（1954-2014・4回）", flag: "🇩🇪" },
  { name: "コートジボワール", code: "CIV", group: "E", fifaRanking: 34, region: "CAF", regionLabel: "アフリカ", wcAppearances: 4, bestResult: "GL敗退（2006-2014）", flag: "🇨🇮" },
  { name: "エクアドル", code: "ECU", group: "E", fifaRanking: 23, region: "CONMEBOL", regionLabel: "南米", wcAppearances: 5, bestResult: "ベスト16（2006）", flag: "🇪🇨" },
  { name: "キュラソー", code: "CUW", group: "E", fifaRanking: 82, region: "CONCACAF", regionLabel: "北中米カリブ海", wcAppearances: 1, bestResult: "初出場", flag: "🇨🇼" },
  ...
  { name: "チュニジア", code: "TUN", group: "F", fifaRanking: 44, region: "CAF", regionLabel: "アフリカ", wcAppearances: 7, bestResult: "GL敗退（1978-2022）", flag: "🇹🇳" },
  { name: "スウェーデン", code: "SWE", group: "F", fifaRanking: 38, region: "UEFA", regionLabel: "ヨーロッパ", wcAppearances: 14, bestResult: "準優勝（1958）", flag: "🇸🇪" },
  ...
  { name: "サウジアラビア", code: "KSA", group: "H", fifaRanking: 61, region: "AFC", regionLabel: "アジア", wcAppearances: 7, bestResult: "ベスト16（1994）", flag: "🇸🇦" },
  ...
  { name: "ボリビア", code: "BOL", group: "I", fifaRanking: 76, region: "CONMEBOL", regionLabel: "南米", wcAppearances: 4, bestResult: "GL敗退（1930-1994）", flag: "🇧🇴" },
  ...
  { name: "ウズベキスタン", code: "UZB", group: "K", fifaRanking: 50, region: "AFC", regionLabel: "アジア", wcAppearances: 1, bestResult: "初出場", flag: "🇺🇿" },
  { name: "コロンビア", code: "COL", group: "K", fifaRanking: 13, region: "CONMEBOL", regionLabel: "南米", wcAppearances: 7, bestResult: "ベスト8（2014）", flag: "🇨🇴" },
  { name: "ジャマイカ", code: "JAM", group: "K", fifaRanking: 71, region: "CONCACAF", regionLabel: "北中米カリブ海", wcAppearances: 2, bestResult: "GL敗退（1998）", flag: "🇯🇲" },

  // --- グループ L ---
  { name: "イングランド", code: "ENG", group: "L", fifaRanking: 4, region: "UEFA", regionLabel: "ヨーロッパ", wcAppearances: 17, bestResult: "優勝（1966）", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿" },
  { name: "ガーナ", code: "GHA", group: "L", fifaRanking: 73, region: "CAF", regionLabel: "アフリカ", wcAppearances: 5, bestResult: "ベスト8（2010）", flag: "🇬🇭" },
