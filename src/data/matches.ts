...
// --- グループ K: ポルトガル, ウズベキスタン, コロンビア, コンゴ民主共和国 ---
const groupKMatches: Match[] = [
  gl("gl-k-1", "2026-06-18", "02:00", "ポルトガル", "コンゴ民主共和国", "nrg", "K", 1, "NHK総合 / DAZN / NHK BS4K"),
  ...
  gl("gl-k-4", "2026-06-24", "11:00", "コロンビア", "コンゴ民主共和国", "akron", "K", 2),
  gl("gl-k-5", "2026-06-28", "08:30", "コロンビア", "ポルトガル", "hardrock", "K", 3, "NHK総合 / DAZN / NHK BS4K"),
  gl("gl-k-6", "2026-06-28", "08:30", "コンゴ民主共和国", "ウズベキスタン", "mercedes", "K", 3),
];
...
export const worldCupGroups = [
  ...
  { name: "K", teams: ["ポルトガル", "ウズベキスタン", "コロンビア", "コンゴ民主共和国"], venue: "ヒューストン / メキシコシティ" },
