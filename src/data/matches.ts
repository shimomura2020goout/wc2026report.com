...
function ko(
  ...
  home: string, away: string, v: VenueKey,
  round: KnockoutRound, label: string
): Match {
  const vd = venueData[v];
  return {
    id, date, kickoff, homeTeam: home, awayTeam: away,
...
// --- グループ A: メキシコ, 韓国, 南アフリカ, UEFA PO D勝者 ---
const groupAMatches: Match[] = [
  gl("gl-a-1", "2026-06-12", "04:00", "メキシコ", "南アフリカ", "azteca", "A", 1),
  gl("gl-a-2", "2026-06-12", "11:00", "韓国", "UEFA PO D勝者", "akron", "A", 1),
  gl("gl-a-3", "2026-06-19", "01:00", "UEFA PO D勝者", "南アフリカ", "mercedes", "A", 2),
  gl("gl-a-4", "2026-06-19", "10:00", "メキシコ", "韓国", "akron", "A", 2),
  gl("gl-a-5", "2026-06-25", "10:00", "UEFA PO D勝者", "メキシコ", "azteca", "A", 3),
  gl("gl-a-6", "2026-06-25", "10:00", "南アフリカ", "韓国", "bbva", "A", 3),
];

// --- グループ B: カナダ, カタール, スイス, UEFA PO A勝者 ---
const groupBMatches: Match[] = [
  gl("gl-b-1", "2026-06-13", "04:00", "カナダ", "UEFA PO A勝者", "bmo", "B", 1),
  gl("gl-b-2", "2026-06-14", "04:00", "カタール", "スイス", "levis", "B", 1),
  gl("gl-b-3", "2026-06-19", "04:00", "スイス", "UEFA PO A勝者", "sofi", "B", 2),
  gl("gl-b-4", "2026-06-19", "07:00", "カナダ", "カタール", "bc", "B", 2),
  gl("gl-b-5", "2026-06-25", "04:00", "スイス", "カナダ", "bc", "B", 3),
  gl("gl-b-6", "2026-06-25", "04:00", "UEFA PO A勝者", "カタール", "lumen", "B", 3),
];

// --- グループ C: ブラジル, ハイチ, スコットランド, モロッコ ---
const groupCMatches: Match[] = [
  gl("gl-c-1", "2026-06-14", "07:00", "ブラジル", "モロッコ", "metlife", "C", 1),
  gl("gl-c-2", "2026-06-14", "10:00", "ハイチ", "スコットランド", "gillette", "C", 1),
  gl("gl-c-3", "2026-06-20", "07:00", "スコットランド", "モロッコ", "gillette", "C", 2),
  gl("gl-c-4", "2026-06-20", "10:00", "ブラジル", "ハイチ", "lincoln", "C", 2),
  gl("gl-c-5", "2026-06-25", "07:00", "スコットランド", "ブラジル", "hardrock", "C", 3),
  gl("gl-c-6", "2026-06-25", "07:00", "モロッコ", "ハイチ", "mercedes", "C", 3),
];

// --- グループ D: アメリカ, パラグアイ, オーストラリア, UEFA PO C勝者 ---
const groupDMatches: Match[] = [
  gl("gl-d-1", "2026-06-13", "10:00", "アメリカ", "パラグアイ", "sofi", "D", 1),
  gl("gl-d-2", "2026-06-14", "13:00", "オーストラリア", "UEFA PO C勝者", "bc", "D", 1),
  gl("gl-d-3", "2026-06-20", "04:00", "アメリカ", "オーストラリア", "lumen", "D", 2),
  gl("gl-d-4", "2026-06-20", "13:00", "UEFA PO C勝者", "パラグアイ", "levis", "D", 2),
  gl("gl-d-5", "2026-06-26", "11:00", "UEFA PO C勝者", "アメリカ", "sofi", "D", 3),
  gl("gl-d-6", "2026-06-26", "11:00", "パラグアイ", "オーストラリア", "levis", "D", 3),
];

// --- グループ E: ドイツ, コートジボワール, エクアドル, キュラソー ---
const groupEMatches: Match[] = [
  gl("gl-e-1", "2026-06-15", "02:00", "ドイツ", "キュラソー", "nrg", "E", 1),
  gl("gl-e-2", "2026-06-15", "08:00", "コートジボワール", "エクアドル", "lincoln", "E", 1),
  gl("gl-e-3", "2026-06-21", "05:00", "ドイツ", "コートジボワール", "bmo", "E", 2),
  gl("gl-e-4", "2026-06-21", "09:00", "エクアドル", "キュラソー", "arrowhead", "E", 2),
  gl("gl-e-5", "2026-06-26", "05:00", "エクアドル", "ドイツ", "metlife", "E", 3),
  gl("gl-e-6", "2026-06-26", "05:00", "キュラソー", "コートジボワール", "lincoln", "E", 3),
];

// --- グループ F: オランダ, 日本, チュニジア, UEFA PO B勝者 --- ★日本所属
const groupFMatches: Match[] = [
  gl("gl-f-1", "2026-06-15", "05:00", "オランダ", "日本", "att", "F", 1,
    "DAZN（無料配信）、NHK総合（地上波）"),
  gl("gl-f-2", "2026-06-15", "11:00", "UEFA PO B勝者", "チュニジア", "bbva", "F", 1),
  gl("gl-f-3", "2026-06-21", "02:00", "オランダ", "UEFA PO B勝者", "nrg", "F", 2),
  gl("gl-f-4", "2026-06-21", "13:00", "チュニジア", "日本", "bbva", "F", 2,
    "DAZN（無料配信）、日本テレビ / NHK BS"),
  gl("gl-f-5", "2026-06-26", "08:00", "日本", "UEFA PO B勝者", "att", "F", 3,
    "DAZN（無料配信）、NHK総合（地上波）"),
...
const groupGMatches: Match[] = [
  gl("gl-g-1", "2026-06-16", "04:00", "ベルギー", "エジプト", "lumen", "G", 1),
  gl("gl-g-2", "2026-06-16", "10:00", "イラン", "ニュージーランド", "sofi", "G", 1),
  gl("gl-g-3", "2026-06-22", "04:00", "ベルギー", "イラン", "sofi", "G", 2),
...
const groupHMatches: Match[] = [
  gl("gl-h-1", "2026-06-16", "01:00", "スペイン", "カーボベルデ", "mercedes", "H", 1),
  gl("gl-h-2", "2026-06-16", "07:00", "サウジアラビア", "ウルグアイ", "hardrock", "H", 1),
  gl("gl-h-3", "2026-06-22", "01:00", "スペイン", "サウジアラビア", "mercedes", "H", 2),
  gl("gl-h-4", "2026-06-22", "07:00", "ウルグアイ", "カーボベルデ", "hardrock", "H", 2),
  gl("gl-h-5", "2026-06-27", "09:00", "カーボベルデ", "サウジアラビア", "nrg", "H", 3),
  gl("gl-h-6", "2026-06-27", "09:00", "ウルグアイ", "スペイン", "akron", "H", 3),
];

// --- グループ I: フランス, セネガル, ノルウェー, 大陸間PO 2勝者 ---
const groupIMatches: Match[] = [
  gl("gl-i-1", "2026-06-17", "04:00", "フランス", "セネガル", "metlife", "I", 1),
  gl("gl-i-2", "2026-06-17", "07:00", "大陸間PO 2勝者", "ノルウェー", "gillette", "I", 1),
  gl("gl-i-3", "2026-06-23", "06:00", "フランス", "大陸間PO 2勝者", "lincoln", "I", 2),
  gl("gl-i-4", "2026-06-23", "09:00", "ノルウェー", "セネガル", "metlife", "I", 2),
  gl("gl-i-5", "2026-06-27", "04:00", "ノルウェー", "フランス", "gillette", "I", 3),
  gl("gl-i-6", "2026-06-27", "04:00", "セネガル", "大陸間PO 2勝者", "bmo", "I", 3),
];

// --- グループ J: アルゼンチン, アルジェリア, オーストリア, ヨルダン ---
const groupJMatches: Match[] = [
  gl("gl-j-1", "2026-06-17", "10:00", "アルゼンチン", "アルジェリア", "arrowhead", "J", 1),
  gl("gl-j-2", "2026-06-17", "13:00", "オーストリア", "ヨルダン", "levis", "J", 1),
  gl("gl-j-3", "2026-06-23", "02:00", "アルゼンチン", "オーストリア", "att", "J", 2),
  gl("gl-j-4", "2026-06-23", "12:00", "ヨルダン", "アルジェリア", "levis", "J", 2),
  gl("gl-j-5", "2026-06-28", "11:00", "アルジェリア", "オーストリア", "arrowhead", "J", 3),
  gl("gl-j-6", "2026-06-28", "11:00", "ヨルダン", "アルゼンチン", "att", "J", 3),
];

// --- グループ K: ポルトガル, ウズベキスタン, コロンビア, 大陸間PO 1勝者 ---
const groupKMatches: Match[] = [
  gl("gl-k-1", "2026-06-18", "02:00", "ポルトガル", "大陸間PO 1勝者", "nrg", "K", 1),
  gl("gl-k-2", "2026-06-18", "11:00", "ウズベキスタン", "コロンビア", "azteca", "K", 1),
  gl("gl-k-3", "2026-06-24", "02:00", "ポルトガル", "ウズベキスタン", "nrg", "K", 2),
  gl("gl-k-4", "2026-06-24", "11:00", "コロンビア", "大陸間PO 1勝者", "akron", "K", 2),
  gl("gl-k-5", "2026-06-28", "08:30", "コロンビア", "ポルトガル", "hardrock", "K", 3),
  gl("gl-k-6", "2026-06-28", "08:30", "大陸間PO 1勝者", "ウズベキスタン", "mercedes", "K", 3),
];

// --- グループ L: イングランド, ガーナ, パナマ, クロアチア ---
const groupLMatches: Match[] = [
  gl("gl-l-1", "2026-06-18", "05:00", "イングランド", "クロアチア", "att", "L", 1),
  gl("gl-l-2", "2026-06-18", "08:00", "ガーナ", "パナマ", "bmo", "L", 1),
  gl("gl-l-3", "2026-06-24", "05:00", "イングランド", "ガーナ", "gillette", "L", 2),
  gl("gl-l-4", "2026-06-24", "08:00", "パナマ", "クロアチア", "bmo", "L", 2),
  gl("gl-l-5", "2026-06-28", "06:00", "パナマ", "イングランド", "metlife", "L", 3),
...
const r32Matches: Match[] = [
  ko("ko-r32-1", 73, "2026-06-29", "04:00", "A組2位", "B組2位", "sofi", "R32", "ラウンド32"),
  ko("ko-r32-2", 74, "2026-06-30", "05:30", "E組1位", "3位通過", "gillette", "R32", "ラウンド32"),
  ko("ko-r32-3", 75, "2026-06-30", "10:00", "F組1位", "C組2位", "bbva", "R32", "ラウンド32"),
  ko("ko-r32-4", 76, "2026-06-30", "02:00", "C組1位", "F組2位", "nrg", "R32", "ラウンド32"),
  ko("ko-r32-5", 77, "2026-07-01", "06:00", "I組1位", "3位通過", "metlife", "R32", "ラウンド32"),
  ko("ko-r32-6", 78, "2026-07-01", "02:00", "E組2位", "I組2位", "att", "R32", "ラウンド32"),
  ko("ko-r32-7", 79, "2026-07-01", "10:00", "A組1位", "3位通過", "azteca", "R32", "ラウンド32"),
  ko("ko-r32-8", 80, "2026-07-02", "01:00", "L組1位", "3位通過", "mercedes", "R32", "ラウンド32"),
  ko("ko-r32-9", 81, "2026-07-02", "09:00", "D組1位", "3位通過", "levis", "R32", "ラウンド32"),
  ko("ko-r32-10", 82, "2026-07-02", "05:00", "G組1位", "3位通過", "lumen", "R32", "ラウンド32"),
  ko("ko-r32-11", 83, "2026-07-03", "08:00", "K組2位", "L組2位", "bmo", "R32", "ラウンド32"),
  ko("ko-r32-12", 84, "2026-07-03", "04:00", "H組1位", "J組2位", "sofi", "R32", "ラウンド32"),
  ko("ko-r32-13", 85, "2026-07-03", "12:00", "B組1位", "3位通過", "bc", "R32", "ラウンド32"),
  ko("ko-r32-14", 86, "2026-07-04", "07:00", "J組1位", "H組2位", "hardrock", "R32", "ラウンド32"),
  ko("ko-r32-15", 87, "2026-07-04", "10:30", "K組1位", "3位通過", "arrowhead", "R32", "ラウンド32"),
  ko("ko-r32-16", 88, "2026-07-04", "03:00", "D組2位", "G組2位", "att", "R32", "ラウンド32"),
];

// --- ラウンド16（8試合）---
const r16Matches: Match[] = [
  ko("ko-r16-1", 89, "2026-07-05", "06:00", "M74勝者", "M77勝者", "lincoln", "R16", "ラウンド16"),
  ko("ko-r16-2", 90, "2026-07-05", "02:00", "M73勝者", "M75勝者", "nrg", "R16", "ラウンド16"),
  ko("ko-r16-3", 91, "2026-07-06", "05:00", "M76勝者", "M78勝者", "metlife", "R16", "ラウンド16"),
  ko("ko-r16-4", 92, "2026-07-06", "09:00", "M79勝者", "M80勝者", "azteca", "R16", "ラウンド16"),
  ko("ko-r16-5", 93, "2026-07-07", "04:00", "M83勝者", "M84勝者", "att", "R16", "ラウンド16"),
  ko("ko-r16-6", 94, "2026-07-07", "09:00", "M81勝者", "M82勝者", "lumen", "R16", "ラウンド16"),
  ko("ko-r16-7", 95, "2026-07-08", "01:00", "M86勝者", "M88勝者", "mercedes", "R16", "ラウンド16"),
  ko("ko-r16-8", 96, "2026-07-08", "05:00", "M85勝者", "M87勝者", "bc", "R16", "ラウンド16"),
];

// --- 準々決勝（4試合）---
const qfMatches: Match[] = [
  ko("ko-qf-1", 97, "2026-07-10", "05:00", "M89勝者", "M90勝者", "gillette", "QF", "準々決勝"),
  ko("ko-qf-2", 98, "2026-07-11", "04:00", "M93勝者", "M94勝者", "sofi", "QF", "準々決勝"),
  ko("ko-qf-3", 99, "2026-07-12", "06:00", "M91勝者", "M92勝者", "hardrock", "QF", "準々決勝"),
  ko("ko-qf-4", 100, "2026-07-12", "10:00", "M95勝者", "M96勝者", "arrowhead", "QF", "準々決勝"),
];

// --- 準決勝（2試合）---
const sfMatches: Match[] = [
  ko("ko-sf-1", 101, "2026-07-15", "04:00", "M97勝者", "M98勝者", "att", "SF", "準決勝"),
  ko("ko-sf-2", 102, "2026-07-16", "04:00", "M99勝者", "M100勝者", "mercedes", "SF", "準決勝"),
];

// --- 3位決定戦 ---
const thirdPlaceMatch: Match[] = [
  ko("ko-3rd", 103, "2026-07-19", "06:00", "準決勝①敗者", "準決勝②敗者", "hardrock", "3rd", "3位決定戦"),
];

// --- 決勝 ---
const finalMatch: Match[] = [
  ko("ko-final", 104, "2026-07-20", "04:00", "準決勝①勝者", "準決勝②勝者", "metlife", "Final", "決勝"),
];
...
export const worldCupGroups = [
  { name: "A", teams: ["メキシコ", "韓国", "南アフリカ", "UEFA PO D勝者"], venue: "メキシコシティ / グアダラハラ" },
  { name: "B", teams: ["カナダ", "カタール", "スイス", "UEFA PO A勝者"], venue: "トロント / バンクーバー" },
  { name: "C", teams: ["ブラジル", "ハイチ", "スコットランド", "モロッコ"], venue: "ニューヨーク / ボストン" },
  { name: "D", teams: ["アメリカ", "パラグアイ", "オーストラリア", "UEFA PO C勝者"], venue: "ロサンゼルス / シアトル" },
  { name: "E", teams: ["ドイツ", "コートジボワール", "エクアドル", "キュラソー"], venue: "ヒューストン / フィラデルフィア" },
  { name: "F", teams: ["オランダ", "日本", "チュニジア", "UEFA PO B勝者"], venue: "ダラス / モンテレイ" },
  { name: "G", teams: ["イラン", "ベルギー", "エジプト", "ニュージーランド"], venue: "ロサンゼルス / シアトル" },
  { name: "H", teams: ["スペイン", "サウジアラビア", "ウルグアイ", "カーボベルデ"], venue: "アトランタ / マイアミ" },
  { name: "I", teams: ["フランス", "セネガル", "ノルウェー", "大陸間PO 2勝者"], venue: "ニューヨーク / ボストン" },
  { name: "J", teams: ["アルゼンチン", "アルジェリア", "オーストリア", "ヨルダン"], venue: "カンザスシティ / ダラス" },
  { name: "K", teams: ["ポルトガル", "ウズベキスタン", "コロンビア", "大陸間PO 1勝者"], venue: "ヒューストン / メキシコシティ" },
